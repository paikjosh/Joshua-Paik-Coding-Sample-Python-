...
The link to that video: https://youtu.be/FKsjrJznxtw  
...
check_outliers(target_file, data_col_name)
-----
...
check_duplicates(target_file, data_col_name)
-----
...
normalize_data(target_file, data_col_name)
-----
