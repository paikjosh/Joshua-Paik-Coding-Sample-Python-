...
Descriptions of files in this repo:
  ...
  3) File titled "test.py" is where I have implemented codes that are on both "data_clean.py" and "data_analysis.py" by using sample data of "TS_sample_data_euro(Sheet1)-2.csv" and "TS_sample_data_dollar(Sheet1)-2.csv"
