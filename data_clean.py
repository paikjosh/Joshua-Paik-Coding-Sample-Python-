...
if __name__ == '__main__':
    # cleaning file with euro currency
    ...
    euro_file_df = convert_input(target_file=euro_file_df, date_col_name='Date')
    print('Data after converting entries data type: ', end='\n')
    print(euro_file_df, end='\n\n')

    euro_file_df = check_for_missing(target_file=euro_file_df)

    euro_file_df = check_outliers(target_file=euro_file_df, date_col_name='Date')
    print('')

    euro_file_df = arrange_file_date(target_file=euro_file_df, target_col_name='Date')
    print('')

    euro_file_df = check_duplicates(target_file=euro_file_df, date_col_name='Date')
    print('')

    euro_file_df = normalize_data(target_file=euro_file_df, date_col_name='Date')
    print('')



    # cleaning file with dollar currency
    ...
    dollar_file_df = check_for_missing(target_file=dollar_file_df)

    dollar_file_df = convert_input(target_file=dollar_file_df, date_col_name='Date')
    print('Data after converting entries data type: ', end='\n')
    ...
    dollar_file_df = check_outliers(target_file=dollar_file_df, date_col_name='Date')
    print('')

    dollar_file_df = arrange_file_date(target_file=dollar_file_df, target_col_name='Date')
    print('')

    dollar_file_df = check_duplicates(target_file=dollar_file_df, date_col_name='Date')
    print('')

    dollar_file_df = normalize_data(target_file=dollar_file_df, date_col_name='Date')
    print('')



    # merging two datasets
    merged_file_outer = pd.merge(euro_file_df, dollar_file_df, how='outer')
    print('Merged file using outer merge:', end = '\n')
    print(merged_file_outer, end='\n\n')

    # making data stationary
    merged_file_outer = convert_stationarity(target_file=merged_file_outer, date_col_name='Date')
